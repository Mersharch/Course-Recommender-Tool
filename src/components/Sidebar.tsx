...
const Sidebar:React.FC = () => {
  return (
    <nav className='w-full md:w-[23%] lg:w-[12%] md:min-h-screen border-r-0 bg-blue-600'>
      <ul className='flex flex-row w-full md:flex-col border-r-0 items-center md:pl-2 md:p-0 justify-between md:justify-normal '>
